    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-2xl">
        <div className="flex justify-between items-center p-4 border-b border-[#e0e0e0]">
          <h2 className="text-xl font-medium">Aprovar campanha</h2>
        ...
        <div className="p-6">
          <p className="mb-4">
            Você está prestes a aprovar esta campanha. Isso a tornará visível
        ...
        <div className="flex border-t border-[#e0e0e0]">
          ...
          <button
            ...
            className="flex-1 p-4 text-center bg-[#161616] text-white hover:bg-[#262626] transition-colors"
          >
            Aprovar
          </button>
        </div>
